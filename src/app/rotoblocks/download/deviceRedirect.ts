...
// scripts/verify-rotoblocks-download-route.js can require it directly under
// plain Node during the Cloudflare build, without a TypeScript loader. This
// file only adds types for the app code that consumes it.
import shared from "@/lib/rotoBlocksDeviceRedirect.cjs";
